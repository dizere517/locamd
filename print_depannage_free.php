...
?><!DOCTYPE html>
<html lang="fr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Demande de dépannage</title>
<style>
...
<body><div class="page">
  ...
  <table>
    <tr>
      ...
      <td style="width:30%;">
        ...
        <div class="line"><?php echo e($p["date"]); ?></div>
        <div style="height:14px;"></div>
        <div class="label">HEURE :</div>
        <div class="line"><?php echo e(date("H:i")); ?></div>
      </td>
    </tr>
  </table>

  <div class="block">
    <div><span class="label">Numero de parc :</span> <span class="line"><?php echo e($p["num"]); ?></span>
      &nbsp;&nbsp;&nbsp; <span class="label">TYPE de machine :</span> <span class="line"><?php echo e($p["type"]); ?></span>
    </div>
  </div>
  ...
  <div class="block">
    <div><span class="label">NOM DU TECHNICIEN :</span> <span class="line"><?php echo e($p["tech"]); ?></span></div>
  </div>
